...
export const updateSequence = async function(userId: string, itemId: string, options:any = {}){
...
const changeRating = async function(userId: string, itemId: string, options: any){
  ...
  removeRating ? await client.srem(feelingUserSet, itemId) :
    await client.sadd(feelingUserSet, itemId);
  removeRating ? await client.srem(feelingItemSet, userId) :
...
export const liked = function(userId: string, itemId: string, options:any = {}){
  options.liked = true;
  return changeRating(userId, itemId, options);
};

export const disliked = function(userId: string, itemId: string, options:any = {}){
  options.liked = false;
  return changeRating(userId, itemId, options);
};

export const unliked = function(userId: string, itemId: string, options:any= {}){
  options.liked = true;
  options.removeRating = true;
  return changeRating(userId, itemId, options);
};

export const undisliked = function(userId: string, itemId: string, options:any = {}){
  options.liked = false;
  options.removeRating = true;
  return changeRating(userId, itemId, options);
};
